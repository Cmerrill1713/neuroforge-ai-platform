...
export const PANELS: Panel[] = [
  ...
  { id: 'voice', name: 'Voice Agent', icon: <RecordVoiceOverIcon />, color: '#9c27b0' },
  { id: 'dia', name: 'DIA LLM', icon: <SmartToyIcon />, color: '#9C27B0' },
  ...
  { id: 'settings', name: 'Settings', icon: <SettingsIcon />, color: '#795548' }
];

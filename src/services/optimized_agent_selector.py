...
class OptimizedAgentSelector:
    ...
    async def _perform_agent_selection(self, task_request: Dict[str, Any]) -> AgentSelectionResult:
        ...
        result = self.base_selector.select_best_agent_with_reasoning(task_request)
    ...
    async def get_performance_stats(self) -> Dict[str, Any]:
        ...
        # Handle JSON compliance for float values
        ...
        # Clean selection stats for JSON compliance
        clean_selection_stats = {}
        for key, value in self.selection_stats.items():
            clean_selection_stats[key] = safe_float(value)

        return {
            "selection_stats": clean_selection_stats,
            "memory_cache": cache_stats,
            "redis_cache": redis_stats,
            "performance_target_met": self.selection_stats["avg_selection_time"] < 2.0,
            "cache_efficiency": safe_float(

...
Runs on port 8005 and provides:
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info("   Backend API: http://localhost:8005")
    ...
    return {
        ...
        "services": {
            ...
            "rag": {
                ...
                "weaviate": rag_service.weaviate.is_ready() if rag_service and hasattr(rag_service.weaviate, 'is_ready') else False
            }
        }
    }
...
if __name__ == "__main__":
    ...
    logger.info("Starting server on http://0.0.0.0:8005")
    logger.info("Frontend should be on http://localhost:3000")
    logger.info("")

...
class WeaviateStore(VectorStore):
    ...
    def __init__(
        ...
        http_port: int = 8090,
        grpc_port: int = 50051,
        class_name: str = "KnowledgeDocumentBGE",  # ← Updated to BGE collection
        timeout: int = 30,
        ...
        self.http_port = http_port or int(os.getenv("WEAVIATE_HTTP_PORT", "8090"))
        ...
        logger.info(f"✅ Weaviate connected with {connection_pool_size} pooled connections: {self.host}:{self.http_port} (class: {self.class_name})")
    ...
    def _initialize_connection_pool(self):
        ...
        try:
            ...
            logger.info(f"✅ Initialized {len(self.connection_pool)} Weaviate connections")
    ...
    async def _return_connection(self, client):
    ...
    async def query(
        ...
        try:
            ...
            query_kwargs = {
                ...
                "return_properties": ["content", "title", "url", "source_type", "domain"]
            }

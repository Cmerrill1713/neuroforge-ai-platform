...
class OllamaAdapter:
    ...
    def __init__(self, base_url: str = "http://localhost:11434"):
        ...
        # Model key mapping - logical names to actual Ollama model names
        self.model_mapping = {
            "primary": "qwen2.5:7b",
            "coding": "mistral:7b", 
    ...
    async def generate_text(
        ...
        **kwargs
        ...
        try:
            ...
            # Map logical model key to actual Ollama model name
            actual_model = self.model_mapping.get(model_key, model_key)
    ...
    async def generate_response(
        ...
        **kwargs
        ...
        # Map logical model key to actual Ollama model name for response
        actual_model = self.model_mapping.get(model_key, model_key)

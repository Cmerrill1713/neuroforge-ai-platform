...
import { Send, Bot, User, Paperclip, Mic, X, MicOff, Volume2, Image as ImageIcon } from 'lucide-react'
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    {message.content && (
                      <button 
                        ...
                        className={`p-1 rounded-full hover:bg-muted-foreground/20 text-muted-foreground ${speakingMessageId === message.id ? 'text-primary' : ''}`}

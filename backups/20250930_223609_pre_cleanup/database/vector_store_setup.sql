-- Vector Store Database Setup for AI System
-- Run this script to initialize the vector database

-- Create vector store database (if not using ai_system)
-- CREATE DATABASE vector_db;

-- Use the ai_system database
\c ai_system;

-- Create vector_documents table for storing document embeddings
...
-- Verify setup
SELECT 'Vector store database setup complete!' as status;
